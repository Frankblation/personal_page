...
import { cnoise21 } from "@/lib/glsl/noise"
...
const vec3 color1 = vec3(0.173,0.169,0.235); // Greenish
const vec3 color2 = vec3(0.749,0.412,0.); // Purple
const vec3 color3 = vec3(0.173,0.169,0.235) ; // Blue
