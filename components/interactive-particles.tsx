...
export default function InteractiveParticles() {
  ...
  const initParticles = (width: number, height: number) => {
    ...
    const particleCount = Math.min(Math.floor((width * height) / 12000), 60) // Adjust density based on screen size
  ...
  const animate = () => {
    ...
    particlesRef.current.forEach((particle) => {
      ...
      // Interactive effect - particles grow and move away from mouse
